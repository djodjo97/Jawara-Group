                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="functions/function_agen.php" method="POST">
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label col-form-label-sm">Nama Agen</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="row mb-3">
                                        <label for="inputEmail3" class="col-sm-2 col-form-label col-form-label-sm">Alamat Agen</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-outline-secondary btn-sm" href="data_agen.php">Batal</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th style="text-align: center;">Nama Agen</th>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($all as $data) { ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="<?= 'edit_agen.php?id_agents=' . $data['id_agents']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-pen"></i></a>
                                    &nbsp;<a href="<?= 'functions/function_agen.php?hapus=' . $data['id_agents']; ?>" onclick="return confirm('Are you sure ?')" class="btn btn-danger btn-circle btn-sm"><i class="fas fa-trash"></i></a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
