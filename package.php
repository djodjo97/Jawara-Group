            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="regist_number" class="form-control form-control-sm" id="inputEmail3" require>
                    </div>
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                      <select name="category_code" class="custom-select">
                        <option selected>Pilih Kategori</option>
                        <?php $category_list=getCategoryProducts();
                        ?>
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <?php foreach ($all as $data) { ?>
              <tr>
                <td style="text-align: center;"><?= $data['regist_number'] ?></td>
