                            ...
                            <div class="modal-body">
                                <form action="functions/function_package.php" method="POST">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <a class="btn btn-outline-secondary btn-sm" href="data_package.php">Batal</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($all as $data) { ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="<?= 'edit_package.php?package_code=' . $data['package_code']; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-pen"></i></a>
